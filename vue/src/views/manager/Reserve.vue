  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="classroomName" label="教室" show-overflow-tooltip></el-table-column>
        <el-table-column prop="classroomadminName" label="教室管理员" show-overflow-tooltip></el-table-column>
...
<!--            <el-button plain type="warning" size="mini" @click="changeStatus(scope.row,'已结束')" v-if="user.role!=='STUDENT' && scope.row.dostatus==='使用中'">结束使用</el-button>-->
            <el-button plain type="warning" size="mini" @click="changeStatus(scope.row,'已结束')" v-if="scope.row.dostatus==='使用中'">结束使用</el-button>
  ...
  methods: {
      ...
      submit(){
          ...
          let data={
              ...
              classroomadminId:this.form.classroomadminId,
              status:'待处理'
          }
