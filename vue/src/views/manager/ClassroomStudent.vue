<template>
  <div>
    <div class="search">
        <el-select v-model="typeId" placeholder="请选择教室分类" style="width: 200px">
            <el-option v-for="item in typeData" :label="item.name" :value="item.id"></el-option>
        </el-select>
      <el-input placeholder="请输入教室编号" style="width: 200px;margin-left: 5px" v-model="name"></el-input>
          ...
          <el-row :gutter="20">
              <el-col :span="5" v-for="item in tableData">
                  <div style="background-color: #ecf7fc" class="card">
                      ...
                      <div style="margin-top: 5px">描述：{{item.descr}}</div>
                      <div style="margin-top: 5px">类型：{{item.typeName}}</div>
