...
public class TokenUtils {
    ...
    private static ClassroomadminService staticClassroomadminService;
    ...
    public void setUserService() {
        ...
        staticClassroomadminService = classroomadminService;
    ...
    public static Account getCurrentUser() {
        try {
            ...
            if (ObjectUtil.isNotEmpty(token)) {
                ...
                if(RoleEnum.CLASSROOMADMIN.name().equals(role)){
                    return staticClassroomadminService.selectById(Integer.valueOf(userId));
                }
